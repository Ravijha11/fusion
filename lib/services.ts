...
export const services: ServiceData[] = [
  {
    ...
    heroHeadline: 'Refrigerator Repair — New York, NY',
    startingPrice: '$89',
    commonFaults: [
    ...
    seoTitle: 'Refrigerator Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Expert refrigerator repair service in New York, NY. Earlier slots may be available; not guaranteed. Qualified technicians (licensing where required). Starting at $89.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Washing Machine Repair — New York, NY',
    startingPrice: '$79',
    commonFaults: [
    ...
    seoTitle: 'Washing Machine Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Professional washing machine repair in New York, NY. All brands serviced. Earlier slots may be available; not guaranteed. Starting at $79.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Dryer Repair — New York, NY',
    startingPrice: '$79',
    commonFaults: [
      'Dryer not heating',
    ...
    seoTitle: 'Dryer Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Expert dryer repair in New York, NY. Gas and electric models. Earlier slots may be available; not guaranteed. Starting at $79.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Oven & Range Repair — New York, NY',
    startingPrice: '$89',
    commonFaults: [
      'Oven not heating',
      'Uneven cooking',
    ...
    seoTitle: 'Oven & Range Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Professional oven and range repair in New York, NY. Gas and electric. Earlier slots may be available; not guaranteed. Starting at $89.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Dishwasher Repair — New York, NY',
    startingPrice: '$79',
    commonFaults: [
    ...
    seoTitle: 'Dishwasher Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Expert dishwasher repair in New York, NY. All brands serviced. Earlier slots may be available; not guaranteed. Starting at $79.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Microwave Repair — New York, NY',
    startingPrice: '$69',
    commonFaults: [
      'Not heating food',
    ...
    seoTitle: 'Microwave Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Professional microwave repair in New York, NY. Safe service. Earlier slots may be available; not guaranteed. Starting at $69.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Air Conditioner Repair — New York, NY',
    startingPrice: '$99',
    commonFaults: [
    ...
    seoTitle: 'Air Conditioner Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Expert AC repair in New York, NY. Window and central units. Earlier slots may be available; not guaranteed. Starting at $99.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Television Repair — New York, NY',
    startingPrice: '$79',
    commonFaults: [
      'No picture',
      'No sound',
    ...
    seoTitle: 'Television Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Professional TV repair in New York, NY. All brands and types. Earlier slots may be available; not guaranteed. Starting at $79.',
    imagePrompts: {
  ...
  },
  {
    ...
    heroHeadline: 'Computer Repair — New York, NY',
    startingPrice: '$69',
    commonFaults: [
      'Slow performance',
      'Won\'t start',
    ...
    seoTitle: 'Computer Repair — New York, NY | Your Home Appliance Care',
    seoDescription:
      'Expert computer and laptop repair in New York, NY. All brands. Earlier slots may be available; not guaranteed. Starting at $69.',
    imagePrompts: {
